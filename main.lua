require "button" -- Importing the button module

alpha = 0 -- Setting the alpha value for transparency

-- Contains information about the squares in the game (what is in each square)
local squares = {"", "", "", "", "", "", "", "", ""}

-- The game uses invisible buttons to check for player input
local buttons = {
    game_state = {},
    win_state = {}
}
...
-- Restarts the game (Resets some variables)
...
function love.update(dt)
    if game_state["game"] then
        for i, v in pairs(squares) do
            ...
            if squares[1] == "x" and squares[2] == "x" and squares[3] == "x" or
                squares[4] == "x" and squares[5] == "x" and squares[6] == "x" or
                squares[7] == "x" and squares[8] == "x" and squares[9] == "x" or
                squares[1] == "x" and squares[4] == "x" and squares[7] == "x" or
                squares[3] == "x" and squares[6] == "x" and squares[9] == "x" or
                squares[1] == "x" and squares[5] == "x" and squares[9] == "x" or
                squares[3] == "x" and squares[5] == "x" and squares[7] == "x" then
                timer = timer + dt
                winner = "X"
            end
            if squares[1] == "o" and squares[2] == "o" and squares[3] == "o" or
                squares[4] == "o" and squares[5] == "o" and squares[6] == "o" or
                squares[7] == "o" and squares[8] == "o" and squares[9] == "o" or
                squares[1] == "o" and squares[4] == "o" and squares[7] == "o" or
                squares[3] == "o" and squares[6] == "o" and squares[9] == "o" or
                squares[1] == "o" and squares[5] == "o" and squares[9] == "o" or
                squares[3] == "o" and squares[5] == "o" and squares[7] == "o" then
                timer = timer + dt
                winner = "O"
            end
        end
        ...
        -- A short delay before the win/draw screen
        if timer >= 1 then
            win()
        end
    elseif game_state["win"] then
        -- If this wasn't here, the player could restart the game without seeing to the win screen
        if timer <= 2 then
            timer = timer + dt
        end
    end
...
-- This is triggered whenever the left mouse button is released and the cursor is on a square
function click(i)
...
-- Called to draw graphics on the screen
function love.draw()
